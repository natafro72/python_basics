...
a = v - i
if a > 0:
    print('Финансовый результат - прибыль. Ее величина: ', a)
    print('Рентабельность выручки = ',v // i)
    s = int(input('Введите численность сотрудников фирмы: '))
    print('Прибыль фирмы в расчете на одного сотрудника: ', a // s)
else:
    print('Финансовый результат - убытки. Величина убытков: ', i - v)
